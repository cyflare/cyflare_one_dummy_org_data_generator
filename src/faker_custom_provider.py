...
class CustomProvider(BaseProvider):
    ...
    def channel(self):
        return random.choice(["Email", "Chat"])
    ...
    def event_name(self):
        return random.choice(
            [
                ...
                "UNICOREANTIVIRUS",
                "CUSTOM_SUSPICIOUS_POWERSHELL_SCRIPT_DETECTION",
                "CUSTOM_POTENTIALLY_MALICIOUS_WINDOWS_ACTIVITY",
                "CUSTOM_O365_SUCCESSFUL_LOGIN_OUTSIDE_THE_US",
                "CUSTOM_SUSPICIOUS_SCAN_LOOP_ON_NETWORK",
                "CUSTOM_POTENTIAL_METASPLOIT_ACTIVITY",
                "CUSTOM_KNOWN_MALICIOUS_USER_AGENT_DETECTION",
                "AZURE_SUSPICIOUS_CHANGES_TO_CONDITIONAL_ACCESS_POLICY",
                "EXPLOIT_ATTEMPT_CORRELATION",
            ]
        )

    # If created for a ticket, closure_reason = "Potential/confirmed incident by SOC". Else, make random.
